...
@Component({
  selector: 'app-first-gen-filter',
  templateUrl: './first-gen-filter.component.html',
  styleUrls: ['./first-gen-filter.component.scss'],
  animations: appAnimations
})
export class FirstGenFilterComponent extends FilterComponent {
