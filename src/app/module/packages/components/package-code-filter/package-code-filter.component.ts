...
@Component({
  selector: 'app-package-code-filter',
  templateUrl: './package-code-filter.component.html',
  styleUrls: ['./package-code-filter.component.scss'],
  animations: appAnimations
})
export class PackageCodeFilterComponent extends FilterComponent {
  public minDate: Date;
  public maxDate: Date;
  ...
  get nameControl(): AbstractControl {
    return this.form.get('withPackageName') as FormControl;
  }
